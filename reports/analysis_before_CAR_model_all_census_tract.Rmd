...
```{r}
ggcorr(data = fhs_model_df[, c(14:35, ncol(fhs_model_df))])
```
...
# Correlations among climate related variables

Excluding variables in collin_var_names

```{r}
climate_var_idx <- c(14:35, 52:61)
...
```{r}
flood_risk <- fhs_model_df[, c(14:23, 25:35)] 
...
We started out with 22 variables; including seven PC scores would include 90% of the variance.
