...
```{r}
saveRDS(beta_inference, file = here("modeling_files/stratified_analysis/beta_inference_files/CHD_poverty.RData"))
```
...
```{r}
saveRDS(beta_inference, file = here("modeling_files/stratified_analysis/beta_inference_files/CHD_rpl1.RData"))
```
...
```{r}
saveRDS(beta_inference, file = here("modeling_files/stratified_analysis/beta_inference_files/CHD_rpl2.RData"))
```
...
```{r}
saveRDS(beta_inference, file = here("modeling_files/stratified_analysis/beta_inference_files/CHD_rpl3.RData"))
```
...
```{r}
saveRDS(beta_inference, file = here("modeling_files/stratified_analysis/beta_inference_files/CHD_rpl4.RData"))
```
...
```{r}
saveRDS(beta_inference, file = here("modeling_files/stratified_analysis/beta_inference_files/CHD_rpls.RData"))
```
...
```{r}
saveRDS(beta_inference, file = here("modeling_files/stratified_analysis/beta_inference_files/BPHIGH_poverty.RData"))
```
...
```{r}
saveRDS(beta_inference, file = here("modeling_files/stratified_analysis/beta_inference_files/BPHIGH_rpl1.RData"))
```
...
```{r}
saveRDS(beta_inference, file = here("modeling_files/stratified_analysis/beta_inference_files/BPHIGH_rpl2.RData"))
```
...
```{r}
saveRDS(beta_inference, file = here("modeling_files/stratified_analysis/beta_inference_files/BPHIGH_rpl3.RData"))
```
...
```{r}
saveRDS(beta_inference, file = here("modeling_files/stratified_analysis/beta_inference_files/BPHIGH_rpl4.RData"))
```
...
```{r}
saveRDS(beta_inference, file = here("modeling_files/stratified_analysis/beta_inference_files/BPHIGH_rpls.RData"))
```
...
```{r}
saveRDS(beta_inference, file = here("modeling_files/stratified_analysis/beta_inference_files/CASTHMA_poverty.RData"))
```
...
```{r}
saveRDS(beta_inference, file = here("modeling_files/stratified_analysis/beta_inference_files/CASTHMA_rpl1.RData"))
```
...
```{r}
saveRDS(beta_inference, file = here("modeling_files/stratified_analysis/beta_inference_files/CASTHMA_rpl2.RData"))
```
...
```{r}
saveRDS(beta_inference, file = here("modeling_files/stratified_analysis/beta_inference_files/CASTHMA_rpl3.RData"))
```
...
```{r}
saveRDS(beta_inference, file = here("modeling_files/stratified_analysis/beta_inference_files/CASTHMA_rpl4.RData"))
```
...
```{r}
saveRDS(beta_inference, file = here("modeling_files/stratified_analysis/beta_inference_files/CASTHMA_rpls.RData"))
```
...
```{r}
saveRDS(beta_inference, file = here("modeling_files/stratified_analysis/beta_inference_files/MHLTH_poverty.RData"))
```
...
```{r}
saveRDS(beta_inference, file = here("modeling_files/stratified_analysis/beta_inference_files/MHLTH_rpl1.RData"))
```
...
```{r}
saveRDS(beta_inference, file = here("modeling_files/stratified_analysis/beta_inference_files/MHLTH_rpl2.RData"))
```
...
```{r}
saveRDS(beta_inference, file = here("modeling_files/stratified_analysis/beta_inference_files/MHLTH_rpl3.RData"))
```
...
```{r}
saveRDS(beta_inference, file = here("modeling_files/stratified_analysis/beta_inference_files/MHLTH_rpl4.RData"))
```
...
```{r}
saveRDS(beta_inference, file = here("modeling_files/stratified_analysis/beta_inference_files/MHLTH_rpls.RData"))
```
