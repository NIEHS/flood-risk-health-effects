...
p <- ggplot(beta_inference_df_strat0[-1, ], aes(x = var_name, y = post_median)) + 
  ...
  scale_x_discrete(labels = c("PC 1", "PC 2", "PC 3", "PC 4", "PC 5",
                              ...
                              "Smoking")) + ggtitle("95% Credible Intervals of Coefficients, Coronary Heart Disease, First Strata")
...
p <- ggplot(beta_inference_df_strat1[-1, ], aes(x = var_name, y = post_median)) + 
  ...
  scale_x_discrete(labels = c("PC 1", "PC 2", "PC 3", "PC 4", "PC 5",
                              ...
                              "CO", "NO2", "O3", "PM10", "PM2.5", "SO2",
                              "Summer Temperature", "Winter Temperature", "Summer Humidity", "Winter Humidity",
                              "Smoking")) + ggtitle("95% Credible Intervals of Coefficients, Coronary Heart Disease, Second Strata")
