...
fhs_model_df <- fhs_model_df[, -(ncol(fhs_model_df) + c(-3, -2, 0))]
...
save(chain1, chain2, chain3, file = here("modeling_files/sensitivity_analysis/ff_grouped/all_census_tract_BPHIGH.RData"))
