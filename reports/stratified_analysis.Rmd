...
p <- ggplot(beta_inference_df_strat0[-1, ], aes(x = var_name, y = post_median, color = strat)) + 
  ...
  scale_color_manual(name = "Strata",
                     ...
                     drop = FALSE) + 
  geom_hline(yintercept = 0.2 * sd_CHD, col = "red", linetype = "dashed") + 
  geom_hline(yintercept = -0.2 * sd_CHD, col = "red", linetype = "dashed")
...
p <- ggplot(beta_inference_df_strat0[-1, ], aes(x = var_name, y = post_median, color = strat)) + 
  ...
  scale_color_manual(name = "Strata",
                     values = c("#F8766D", "#00BFC4"), 
                     drop = FALSE) + 
  geom_hline(yintercept = 0.2 * sd_BPHIGH, col = "red", linetype = "dashed") + 
  geom_hline(yintercept = -0.2 * sd_BPHIGH, col = "red", linetype = "dashed")
...
p <- ggplot(beta_inference_df_strat0[-1, ], aes(x = var_name, y = post_median, color = strat)) + 
  ...
  scale_color_manual(name = "Strata",
                     values = c("#F8766D", "#00BFC4"), 
                     drop = FALSE) + 
  geom_hline(yintercept = 0.2 * sd_CASTHMA, col = "red", linetype = "dashed") + 
  geom_hline(yintercept = -0.2 * sd_CASTHMA, col = "red", linetype = "dashed")
...
p <- ggplot(beta_inference_df_strat0[-1, ], aes(x = var_name, y = post_median, color = strat)) + 
  ...
  scale_color_manual(name = "Strata",
                     values = c("#F8766D", "#00BFC4"), 
                     drop = FALSE) + 
  geom_hline(yintercept = 0.2 * sd_MHLTH, col = "red", linetype = "dashed") + 
  geom_hline(yintercept = -0.2 * sd_MHLTH, col = "red", linetype = "dashed")
