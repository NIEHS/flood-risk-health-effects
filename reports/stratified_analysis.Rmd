...
```{r}
beta_inference <- readRDS(here("modeling_files/stratified_analysis/beta_inference_files/CHD_poverty.rds"))
```
...
```{r}
beta_inference <- readRDS(here("modeling_files/stratified_analysis/beta_inference_files/CHD_rpl1.rds"))
```
...
p <- ggplot(beta_inference_df_strat0[-1, ], aes(x = var_name, y = post_median, color = strat)) + 
  ...
  scale_x_discrete(labels = c("Flood PC 1", "Flood PC 2", "Flood PC 3", "Flood PC 4", "Flood PC 5",
                              ...
                              "Pollution PC 1", "Pollution PC 2", "Pollution PC 3",
                              "Maximum Temperature", "Maximum Humidity",
                              "Smoking")) + ggtitle("95% Credible Intervals, Coronary Heart Disease, Stratified on SVI Theme 1") + 
  geom_point(data = beta_inference_df_strat1[-1, ], col = "#00BFC4") + # strat 1
  geom_errorbar(data = beta_inference_df_strat1[-1, ], aes(ymin = post_2.5, ymax = post_97.5, width = 0.4), col = "#00BFC4") + 
  scale_color_manual(name = "Strata",
                     values = c("#F8766D", "#00BFC4"), 
...
```{r}
beta_inference <- readRDS(here("modeling_files/stratified_analysis/beta_inference_files/CHD_rpl2.rds"))
```
...
p <- ggplot(beta_inference_df_strat0[-1, ], aes(x = var_name, y = post_median, color = strat)) + 
  ...
  scale_x_discrete(labels = c("Flood PC 1", "Flood PC 2", "Flood PC 3", "Flood PC 4", "Flood PC 5",
                              ...
                              "Pollution PC 1", "Pollution PC 2", "Pollution PC 3",
                              "Maximum Temperature", "Maximum Humidity",
                              "Smoking")) + ggtitle("95% Credible Intervals, Coronary Heart Disease, Stratified on SVI Theme 2") + 
  geom_point(data = beta_inference_df_strat1[-1, ], col = "#00BFC4") + # strat 1
  geom_errorbar(data = beta_inference_df_strat1[-1, ], aes(ymin = post_2.5, ymax = post_97.5, width = 0.4), col = "#00BFC4") + 
  scale_color_manual(name = "Strata",
                     values = c("#F8766D", "#00BFC4"), 
...
```{r}
beta_inference <- readRDS(here("modeling_files/stratified_analysis/beta_inference_files/CHD_rpl3.rds"))
```
...
p <- ggplot(beta_inference_df_strat0[-1, ], aes(x = var_name, y = post_median, color = strat)) + 
  ...
  scale_x_discrete(labels = c("Flood PC 1", "Flood PC 2", "Flood PC 3", "Flood PC 4", "Flood PC 5",
                              ...
                              "Pollution PC 1", "Pollution PC 2", "Pollution PC 3",
                              "Maximum Temperature", "Maximum Humidity",
                              "Smoking")) + ggtitle("95% Credible Intervals, Coronary Heart Disease, Stratified on SVI Theme 3") + 
  geom_point(data = beta_inference_df_strat1[-1, ], col = "#00BFC4") + # strat 1
  geom_errorbar(data = beta_inference_df_strat1[-1, ], aes(ymin = post_2.5, ymax = post_97.5, width = 0.4), col = "#00BFC4") + 
  scale_color_manual(name = "Strata",
                     values = c("#F8766D", "#00BFC4"), 
...
```{r}
beta_inference <- readRDS(here("modeling_files/stratified_analysis/beta_inference_files/CHD_rpl4.rds"))
```
...
p <- ggplot(beta_inference_df_strat0[-1, ], aes(x = var_name, y = post_median, color = strat)) + 
  ...
  scale_x_discrete(labels = c("Flood PC 1", "Flood PC 2", "Flood PC 3", "Flood PC 4", "Flood PC 5",
                              ...
                              "Pollution PC 1", "Pollution PC 2", "Pollution PC 3",
                              "Maximum Temperature", "Maximum Humidity",
                              "Smoking")) + ggtitle("95% Credible Intervals, Coronary Heart Disease, Stratified on SVI Theme 4") + 
  geom_point(data = beta_inference_df_strat1[-1, ], col = "#00BFC4") + # strat 1
  geom_errorbar(data = beta_inference_df_strat1[-1, ], aes(ymin = post_2.5, ymax = post_97.5, width = 0.4), col = "#00BFC4") + 
  scale_color_manual(name = "Strata",
                     values = c("#F8766D", "#00BFC4"), 
...
```{r}
beta_inference <- readRDS(here("modeling_files/stratified_analysis/beta_inference_files/CHD_rpls.rds"))
```
...
p <- ggplot(beta_inference_df_strat0[-1, ], aes(x = var_name, y = post_median, color = strat)) + 
  ...
  scale_x_discrete(labels = c("Flood PC 1", "Flood PC 2", "Flood PC 3", "Flood PC 4", "Flood PC 5",
                              ...
                              "Pollution PC 1", "Pollution PC 2", "Pollution PC 3",
                              "Maximum Temperature", "Maximum Humidity",
                              "Smoking")) + ggtitle("95% Credible Intervals, Coronary Heart Disease, Stratified on All SVI Themes") + 
  geom_point(data = beta_inference_df_strat1[-1, ], col = "#00BFC4") + # strat 1
  geom_errorbar(data = beta_inference_df_strat1[-1, ], aes(ymin = post_2.5, ymax = post_97.5, width = 0.4), col = "#00BFC4") + 
  scale_color_manual(name = "Strata",
                     values = c("#F8766D", "#00BFC4"), 
...
```{r}
beta_inference <- readRDS(here("modeling_files/stratified_analysis/beta_inference_files/BPHIGH_poverty.rds"))
```
...
```{r}
beta_inference <- readRDS(here("modeling_files/stratified_analysis/beta_inference_files/BPHIGH_rpl1.rds"))
```
...
p <- ggplot(beta_inference_df_strat0[-1, ], aes(x = var_name, y = post_median, color = strat)) + 
  ...
  scale_x_discrete(labels = c("Flood PC 1", "Flood PC 2", "Flood PC 3", "Flood PC 4", "Flood PC 5",
                              ...
                              "Pollution PC 1", "Pollution PC 2", "Pollution PC 3",
                              "Maximum Temperature", "Maximum Humidity",
                              "Smoking")) + ggtitle("95% Credible Intervals, High Blood Pressure, Stratified on SVI Theme 1") + 
  geom_point(data = beta_inference_df_strat1[-1, ], col = "#00BFC4") + # strat 1
  geom_errorbar(data = beta_inference_df_strat1[-1, ], aes(ymin = post_2.5, ymax = post_97.5, width = 0.4), col = "#00BFC4") + 
  scale_color_manual(name = "Strata",
                     values = c("#F8766D", "#00BFC4"), 
...
```{r}
beta_inference <- readRDS(here("modeling_files/stratified_analysis/beta_inference_files/BPHIGH_rpl2.rds"))
```
...
p <- ggplot(beta_inference_df_strat0[-1, ], aes(x = var_name, y = post_median, color = strat)) + 
  ...
  scale_x_discrete(labels = c("Flood PC 1", "Flood PC 2", "Flood PC 3", "Flood PC 4", "Flood PC 5",
                              ...
                              "Pollution PC 1", "Pollution PC 2", "Pollution PC 3",
                              "Maximum Temperature", "Maximum Humidity",
                              "Smoking")) + ggtitle("95% Credible Intervals, High Blood Pressure, Stratified on SVI Theme 2") + 
  geom_point(data = beta_inference_df_strat1[-1, ], col = "#00BFC4") + # strat 1
  geom_errorbar(data = beta_inference_df_strat1[-1, ], aes(ymin = post_2.5, ymax = post_97.5, width = 0.4), col = "#00BFC4") + 
  scale_color_manual(name = "Strata",
                     values = c("#F8766D", "#00BFC4"), 
...
```{r}
beta_inference <- readRDS(here("modeling_files/stratified_analysis/beta_inference_files/BPHIGH_rpl3.rds"))
```
...
p <- ggplot(beta_inference_df_strat0[-1, ], aes(x = var_name, y = post_median, color = strat)) + 
  ...
  scale_x_discrete(labels = c("Flood PC 1", "Flood PC 2", "Flood PC 3", "Flood PC 4", "Flood PC 5",
                              ...
                              "Pollution PC 1", "Pollution PC 2", "Pollution PC 3",
                              "Maximum Temperature", "Maximum Humidity",
                              "Smoking")) + ggtitle("95% Credible Intervals, High Blood Pressure, Stratified on SVI Theme 3") + 
  geom_point(data = beta_inference_df_strat1[-1, ], col = "#00BFC4") + # strat 1
  geom_errorbar(data = beta_inference_df_strat1[-1, ], aes(ymin = post_2.5, ymax = post_97.5, width = 0.4), col = "#00BFC4") + 
  scale_color_manual(name = "Strata",
                     values = c("#F8766D", "#00BFC4"), 
...
```{r}
beta_inference <- readRDS(here("modeling_files/stratified_analysis/beta_inference_files/BPHIGH_rpl4.rds"))
```
...
p <- ggplot(beta_inference_df_strat0[-1, ], aes(x = var_name, y = post_median, color = strat)) + 
  ...
  scale_x_discrete(labels = c("Flood PC 1", "Flood PC 2", "Flood PC 3", "Flood PC 4", "Flood PC 5",
                              ...
                              "Pollution PC 1", "Pollution PC 2", "Pollution PC 3",
                              "Maximum Temperature", "Maximum Humidity",
                              "Smoking")) + ggtitle("95% Credible Intervals, High Blood Pressure, Stratified on SVI Theme 4") + 
  geom_point(data = beta_inference_df_strat1[-1, ], col = "#00BFC4") + # strat 1
  geom_errorbar(data = beta_inference_df_strat1[-1, ], aes(ymin = post_2.5, ymax = post_97.5, width = 0.4), col = "#00BFC4") + 
  scale_color_manual(name = "Strata",
                     values = c("#F8766D", "#00BFC4"), 
...
```{r}
beta_inference <- readRDS(here("modeling_files/stratified_analysis/beta_inference_files/BPHIGH_rpls.rds"))
```
...
p <- ggplot(beta_inference_df_strat0[-1, ], aes(x = var_name, y = post_median, color = strat)) + 
  ...
  scale_x_discrete(labels = c("Flood PC 1", "Flood PC 2", "Flood PC 3", "Flood PC 4", "Flood PC 5",
                              ...
                              "Pollution PC 1", "Pollution PC 2", "Pollution PC 3",
                              "Maximum Temperature", "Maximum Humidity",
                              "Smoking")) + ggtitle("95% Credible Intervals, High Blood Pressure, Stratified on All SVI Themes") + 
  geom_point(data = beta_inference_df_strat1[-1, ], col = "#00BFC4") + # strat 1
  geom_errorbar(data = beta_inference_df_strat1[-1, ], aes(ymin = post_2.5, ymax = post_97.5, width = 0.4), col = "#00BFC4") + 
  scale_color_manual(name = "Strata",
                     values = c("#F8766D", "#00BFC4"), 
...
```{r}
beta_inference <- readRDS(here("modeling_files/stratified_analysis/beta_inference_files/CASTHMA_poverty.rds"))
```
...
```{r}
beta_inference <- readRDS(here("modeling_files/stratified_analysis/beta_inference_files/CASTHMA_rpl1.rds"))
```
...
p <- ggplot(beta_inference_df_strat0[-1, ], aes(x = var_name, y = post_median, color = strat)) + 
  ...
  scale_x_discrete(labels = c("Flood PC 1", "Flood PC 2", "Flood PC 3", "Flood PC 4", "Flood PC 5",
                              ...
                              "Pollution PC 1", "Pollution PC 2", "Pollution PC 3",
                              "Maximum Temperature", "Maximum Humidity",
                              "Smoking")) + ggtitle("95% Credible Intervals, Asthma, Stratified on SVI Theme 1") + 
  geom_point(data = beta_inference_df_strat1[-1, ], col = "#00BFC4") + # strat 1
  geom_errorbar(data = beta_inference_df_strat1[-1, ], aes(ymin = post_2.5, ymax = post_97.5, width = 0.4), col = "#00BFC4") + 
  scale_color_manual(name = "Strata",
                     values = c("#F8766D", "#00BFC4"), 
...
```{r}
beta_inference <- readRDS(here("modeling_files/stratified_analysis/beta_inference_files/CASTHMA_rpl2.rds"))
```
...
p <- ggplot(beta_inference_df_strat0[-1, ], aes(x = var_name, y = post_median, color = strat)) + 
  ...
  scale_x_discrete(labels = c("Flood PC 1", "Flood PC 2", "Flood PC 3", "Flood PC 4", "Flood PC 5",
                              ...
                              "Pollution PC 1", "Pollution PC 2", "Pollution PC 3",
                              "Maximum Temperature", "Maximum Humidity",
                              "Smoking")) + ggtitle("95% Credible Intervals, Asthma, Stratified on SVI Theme 2") + 
  geom_point(data = beta_inference_df_strat1[-1, ], col = "#00BFC4") + # strat 1
  geom_errorbar(data = beta_inference_df_strat1[-1, ], aes(ymin = post_2.5, ymax = post_97.5, width = 0.4), col = "#00BFC4") + 
  scale_color_manual(name = "Strata",
                     values = c("#F8766D", "#00BFC4"), 
...
```{r}
beta_inference <- readRDS(here("modeling_files/stratified_analysis/beta_inference_files/CASTHMA_rpl3.rds"))
```
...
p <- ggplot(beta_inference_df_strat0[-1, ], aes(x = var_name, y = post_median, color = strat)) + 
  ...
  scale_x_discrete(labels = c("Flood PC 1", "Flood PC 2", "Flood PC 3", "Flood PC 4", "Flood PC 5",
                              ...
                              "Pollution PC 1", "Pollution PC 2", "Pollution PC 3",
                              "Maximum Temperature", "Maximum Humidity",
                              "Smoking")) + ggtitle("95% Credible Intervals, Asthma, Stratified on SVI Theme 3") + 
  geom_point(data = beta_inference_df_strat1[-1, ], col = "#00BFC4") + # strat 1
  geom_errorbar(data = beta_inference_df_strat1[-1, ], aes(ymin = post_2.5, ymax = post_97.5, width = 0.4), col = "#00BFC4") + 
  scale_color_manual(name = "Strata",
                     values = c("#F8766D", "#00BFC4"), 
...
```{r}
beta_inference <- readRDS(here("modeling_files/stratified_analysis/beta_inference_files/CASTHMA_rpl4.rds"))
```
...
p <- ggplot(beta_inference_df_strat0[-1, ], aes(x = var_name, y = post_median, color = strat)) + 
  ...
  scale_x_discrete(labels = c("Flood PC 1", "Flood PC 2", "Flood PC 3", "Flood PC 4", "Flood PC 5",
                              ...
                              "Pollution PC 1", "Pollution PC 2", "Pollution PC 3",
                              "Maximum Temperature", "Maximum Humidity",
                              "Smoking")) + ggtitle("95% Credible Intervals, Asthma, Stratified on SVI Theme 4") + 
  geom_point(data = beta_inference_df_strat1[-1, ], col = "#00BFC4") + # strat 1
  geom_errorbar(data = beta_inference_df_strat1[-1, ], aes(ymin = post_2.5, ymax = post_97.5, width = 0.4), col = "#00BFC4") + 
  scale_color_manual(name = "Strata",
                     values = c("#F8766D", "#00BFC4"), 
...
```{r}
beta_inference <- readRDS(here("modeling_files/stratified_analysis/beta_inference_files/CASTHMA_rpls.rds"))
```
...
p <- ggplot(beta_inference_df_strat0[-1, ], aes(x = var_name, y = post_median, color = strat)) + 
  ...
  scale_x_discrete(labels = c("Flood PC 1", "Flood PC 2", "Flood PC 3", "Flood PC 4", "Flood PC 5",
                              ...
                              "Pollution PC 1", "Pollution PC 2", "Pollution PC 3",
                              "Maximum Temperature", "Maximum Humidity",
                              "Smoking")) + ggtitle("95% Credible Intervals, Asthma, Stratified on All SVI Themes") + 
  geom_point(data = beta_inference_df_strat1[-1, ], col = "#00BFC4") + # strat 1
  geom_errorbar(data = beta_inference_df_strat1[-1, ], aes(ymin = post_2.5, ymax = post_97.5, width = 0.4), col = "#00BFC4") + 
  scale_color_manual(name = "Strata",
                     values = c("#F8766D", "#00BFC4"), 
...
```{r}
beta_inference <- readRDS(here("modeling_files/stratified_analysis/beta_inference_files/MHLTH_poverty.rds"))
```
...
```{r}
beta_inference <- readRDS(here("modeling_files/stratified_analysis/beta_inference_files/MHLTH_rpl1.rds"))
```
...
p <- ggplot(beta_inference_df_strat0[-1, ], aes(x = var_name, y = post_median, color = strat)) + 
  ...
  scale_x_discrete(labels = c("Flood PC 1", "Flood PC 2", "Flood PC 3", "Flood PC 4", "Flood PC 5",
                              ...
                              "Pollution PC 1", "Pollution PC 2", "Pollution PC 3",
                              "Maximum Temperature", "Maximum Humidity",
                              "Smoking")) + ggtitle("95% Credible Intervals, Poor Mental Health, Stratified on SVI Theme 1") + 
  geom_point(data = beta_inference_df_strat1[-1, ], col = "#00BFC4") + # strat 1
  geom_errorbar(data = beta_inference_df_strat1[-1, ], aes(ymin = post_2.5, ymax = post_97.5, width = 0.4), col = "#00BFC4") + 
  scale_color_manual(name = "Strata",
                     values = c("#F8766D", "#00BFC4"), 
...
```{r}
beta_inference <- readRDS(here("modeling_files/stratified_analysis/beta_inference_files/MHLTH_rpl2.rds"))
```
...
p <- ggplot(beta_inference_df_strat0[-1, ], aes(x = var_name, y = post_median, color = strat)) + 
  ...
  scale_x_discrete(labels = c("Flood PC 1", "Flood PC 2", "Flood PC 3", "Flood PC 4", "Flood PC 5",
                              ...
                              "Pollution PC 1", "Pollution PC 2", "Pollution PC 3",
                              "Maximum Temperature", "Maximum Humidity",
                              "Smoking")) + ggtitle("95% Credible Intervals, Poor Mental Health, Stratified on SVI Theme 2") + 
  geom_point(data = beta_inference_df_strat1[-1, ], col = "#00BFC4") + # strat 1
  geom_errorbar(data = beta_inference_df_strat1[-1, ], aes(ymin = post_2.5, ymax = post_97.5, width = 0.4), col = "#00BFC4") + 
  scale_color_manual(name = "Strata",
                     values = c("#F8766D", "#00BFC4"), 
...
```{r}
beta_inference <- readRDS(here("modeling_files/stratified_analysis/beta_inference_files/MHLTH_rpl3.rds"))
```
...
p <- ggplot(beta_inference_df_strat0[-1, ], aes(x = var_name, y = post_median, color = strat)) + 
  ...
  scale_x_discrete(labels = c("Flood PC 1", "Flood PC 2", "Flood PC 3", "Flood PC 4", "Flood PC 5",
                              ...
                              "Pollution PC 1", "Pollution PC 2", "Pollution PC 3",
                              "Maximum Temperature", "Maximum Humidity",
                              "Smoking")) + ggtitle("95% Credible Intervals, Poor Mental Health, Stratified on SVI Theme 3") + 
  geom_point(data = beta_inference_df_strat1[-1, ], col = "#00BFC4") + # strat 1
  geom_errorbar(data = beta_inference_df_strat1[-1, ], aes(ymin = post_2.5, ymax = post_97.5, width = 0.4), col = "#00BFC4") + 
  scale_color_manual(name = "Strata",
                     values = c("#F8766D", "#00BFC4"), 
...
```{r}
beta_inference <- readRDS(here("modeling_files/stratified_analysis/beta_inference_files/MHLTH_rpl4.rds"))
```
...
p <- ggplot(beta_inference_df_strat0[-1, ], aes(x = var_name, y = post_median, color = strat)) + 
  ...
  scale_x_discrete(labels = c("Flood PC 1", "Flood PC 2", "Flood PC 3", "Flood PC 4", "Flood PC 5",
                              ...
                              "Pollution PC 1", "Pollution PC 2", "Pollution PC 3",
                              "Maximum Temperature", "Maximum Humidity",
                              "Smoking")) + ggtitle("95% Credible Intervals, Poor Mental Health, Stratified on SVI Theme 4") + 
  geom_point(data = beta_inference_df_strat1[-1, ], col = "#00BFC4") + # strat 1
  geom_errorbar(data = beta_inference_df_strat1[-1, ], aes(ymin = post_2.5, ymax = post_97.5, width = 0.4), col = "#00BFC4") + 
  scale_color_manual(name = "Strata",
                     values = c("#F8766D", "#00BFC4"), 
...
```{r}
beta_inference <- readRDS(here("modeling_files/stratified_analysis/beta_inference_files/MHLTH_rpls.rds"))
```
...
p <- ggplot(beta_inference_df_strat0[-1, ], aes(x = var_name, y = post_median, color = strat)) + 
  ...
  scale_x_discrete(labels = c("Flood PC 1", "Flood PC 2", "Flood PC 3", "Flood PC 4", "Flood PC 5",
                              ...
                              "Pollution PC 1", "Pollution PC 2", "Pollution PC 3",
                              "Maximum Temperature", "Maximum Humidity",
                              "Smoking")) + ggtitle("95% Credible Intervals, Poor Mental Health, Stratified on All SVI Themes") + 
  geom_point(data = beta_inference_df_strat1[-1, ], col = "#00BFC4") + # strat 1
  geom_errorbar(data = beta_inference_df_strat1[-1, ], aes(ymin = post_2.5, ymax = post_97.5, width = 0.4), col = "#00BFC4") + 
  scale_color_manual(name = "Strata",
                     values = c("#F8766D", "#00BFC4"), 
