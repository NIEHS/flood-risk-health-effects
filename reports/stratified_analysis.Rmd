...
beta_inference_df$strat <- as.factor(c(rep(0, (nrow(beta_inference_df)/2)), 
                             rep(1, (nrow(beta_inference_df)/2))))
```
...
```{r}
load(here("modeling_files/model_stratif_rpl1.RData"))
```
...
```{r}
load(here("modeling_files/model_stratif_rpl2.RData"))
```
...
```{r}
load(here("modeling_files/model_stratif_rpl3.RData"))
```
...
p <- ggplot(beta_inference_df_strat1[-1, ], aes(x = var_name, y = post_median)) + 
  ...
  geom_vline(xintercept = c(5.5, 19.5, 25.5, 29.5), col = "blue") +
  geom_hline(yintercept = 0, col = "red") +
  annotate(geom = "text", x = 3, y = 1.75, label = "Flood\nRisk",
           col = "blue", size = 4.5) +
  annotate(geom = "text", x = 11, y = 1.8, label = "Social Vulnerability Index",
           col = "blue", size = 4.5) +
  annotate(geom = "text", x = 19.5, y = 1.8, label = "Air Pollution",
           col = "blue", size = 4.5) +
  annotate(geom = "text", x = 24.5, y = 1.8, label = "GRIDMET",
           col = "blue", size = 4.5) +
  scale_x_discrete(labels = c("PC 1", "PC 2", "PC 3", "PC 4", "PC 5",
                              "Poverty", "Unemployed", "Per Capita Income", "No High School",
                              "65 or Over", "17 or Under", "Disability",
...
```{r}
load(here("modeling_files/model_stratif_rpl4.RData"))
```
...
```{r}
load(here("modeling_files/model_stratif_rpls.RData"))
```
...
p <- ggplot(beta_inference_df_strat0[-1, ], aes(x = var_name, y = post_median)) + 
  ...
  geom_hline(yintercept = 0, col = "red") +
  annotate(geom = "text", x = 3, y = 1.05, label = "Flood\nRisk",
           col = "blue", size = 4.5) +
  annotate(geom = "text", x = 9.5, y = 1.1, label = "Air Pollution",
           col = "blue", size = 4.5) +
  annotate(geom = "text", x = 14.5, y = 1.1, label = "GRIDMET",
           col = "blue", size = 4.5) +
  scale_x_discrete(labels = c("PC 1", "PC 2", "PC 3", "PC 4", "PC 5",
                              "Uninsured",
                              "CO", "NO2", "O3", "PM10", "PM2.5", "SO2",
