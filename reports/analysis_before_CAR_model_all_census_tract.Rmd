...
```{r}
apply(fhs_model_df[fr_index], 2, function(vec) sd(vec, na.rm = T))
```
...
## PCA with Centering and Scaling beforehand
...
Including eight PC scores would include 90% of the variance.
...
```{r}
round(fr_loadings[, 1:5], digits = 2)
```
