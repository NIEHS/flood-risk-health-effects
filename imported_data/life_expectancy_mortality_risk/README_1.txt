...
Suggested citation:
Institute for Health Metrics and Evaluation (IHME). United States Life Expectancy and Age-specific Mortality Risk by County 1980-2014. Seattle, United States: Institute for Health Metrics and Evaluation (IHME), 2017.

Terms and Conditions:
http://www.healthdata.org/about/terms-and-conditions


NOTE ABOUT MORTALITY RISK MEASURE
Mortality risk is defined as the probability of death during the specified age range conditional on being alive at the beginning of this age range.

The value given as the metric for this measure in this dataset is "Percentage." More specifically, this is the probability of the mortality risk expressed as a percentage.