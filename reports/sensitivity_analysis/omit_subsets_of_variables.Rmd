...
```{r}
ggsave(here("figures/final_figures/sensitivity_analysis/CHD_omit_SVI.pdf"),
       plot = p, device = "pdf", 
...
```{r}
ggsave(here("figures/final_figures/sensitivity_analysis/BPHIGH_omit_SVI.pdf"),
       plot = p, device = "pdf", 
       width = 8, height = 6, units = "in")
```
...
```{r}
ggsave(here("figures/final_figures/sensitivity_analysis/CASTHMA_omit_SVI.pdf"),
       plot = p, device = "pdf", 
       width = 8, height = 6, units = "in")
```
...
```{r}
ggsave(here("figures/final_figures/sensitivity_analysis/MHLTH_omit_SVI.pdf"),
       plot = p, device = "pdf", 
       width = 8, height = 6, units = "in")
```
